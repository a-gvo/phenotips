...
public interface Cancer extends VocabularyProperty
{
    ...
    /**
     * Sets qualifiers for {@link Cancer} to the provided {@code qualifiers}.
     */
    void setQualifiers(@Nullable Collection<CancerQualifiers> qualifiers);

    /**
     * Returns a collection of all properties for the {@link Cancer}.
     *
