...
public class DefaultGenePanelImpl implements GenePanel
{
     ...
     */
    private Set<VocabularyTerm> buildPresentFeatures(final Collection<String> presentFeatures)
    {
    ...
    private List<PhenotypesForGene> buildSortedGeneDataFromMap(
        final Map<String, PhenotypesForGene> phenotypesForGeneMap)
    {
     ...
     */
    private void addPhenotypeForGene(final VocabularyTerm term, final List<String> genes,
        final Map<String, PhenotypesForGene> phenotypesForGeneMap)
    {
     ...
     */
    private PhenotypesForGene createPhenotypesForGeneObj(final Map<String, PhenotypesForGene> geneCountsMap,
     ...
     */
    private String getGeneId(final String geneSymbol)
    {
     ...
     */
    @SuppressWarnings("unchecked")
    private List<String> getGeneDataFromTerm(final VocabularyTerm term)
    {
    ...
    /**
     * Returns the total number of genes stored by the gene panel.
     *
     * @return the size of the gene panel
     */
    private int size()
    {
        return this.phenotypesForGeneList.size();
    }
}
